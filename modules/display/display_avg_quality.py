...
def display_average_air_quality(session, country_list):
    try:
        for country in country_list:
            ...
            ax1.plot(x, list(no2_dict.values())[:length], x, list(so2_dict.values())[:length], x,
                     list(o3_dict.values())[:length], x, list(pm25_dict.values())[:length], x,
                     list(pm10_dict.values())[:length])
